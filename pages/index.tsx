...
export default function Home() {
  const postManagerContract = "0x175808e6B4df00e85A114cF119140286a24048ca"; //postManager smart contract address
  ...
  async function createPost() {
    try {
      ...
      if (noOfPosts === 0) {
        ...
        let config: any = {
          method: "get",
          url: `https://bafybeiffjevj7n3k7hsmwf325ynrbyq5pt5m2qcrmer62beyn7jfxhu6ky.ipfs.w3s.link/post.json`,
          headers: {},
        };
      ...
      <div className={styles.activePostContainer}>
        <div>
          ...
          <div style={{ display: "flex" }}>
            ...
            <p className={styles.hyperlinkText}>
              <Link
                href={`https://bafybeiffjevj7n3k7hsmwf325ynrbyq5pt5m2qcrmer62beyn7jfxhu6ky.ipfs.w3s.link/post.json`}
                target="_blank"
              >
                {latestCid}
              </Link>
